...
class SSD:
    ...
    def build_engine(
        ...
        trt_logger,
        batch_size,
        calib_dataset=Path.home() / "VOCdevkit" / "VOC2007" / "JPEGImages",
    ):
        ...
        uff_model = uff.from_tensorflow(
            dynamic_graph.as_graph_def(), [cls.OUTPUT_NAME], quiet=True
        )
...
class SSDMobileNetV1(SSD):
    ...
    def add_plugin(cls, graph):
        ...
        concat_priorbox = gs.create_node(
            "concat_priorbox", op="ConcatV2", dtype=tf.float32, axis=2
        )
